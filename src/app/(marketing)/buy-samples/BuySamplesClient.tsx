      ...
      <div className="flex flex-col flex-1 p-3 gap-2.5">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="w-8 h-8 border border-gray-200 text-neutral-600 hover:bg-gray-100 flex items-center justify-center text-lg font-medium cursor-pointer transition-colors rounded-lg"
          >
            −
          </button>
...
export default function BuySamplesClient() {
  return (
